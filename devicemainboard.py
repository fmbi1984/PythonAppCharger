...
class BCmb(object):
    ...
    def writeProgram(program_in_json):
        result = ACTION.FAIL
        result = devInterface.sendCommandAndGetResponse(0x57, program_in_json, BCmb.timeout)
        print(result)
        if result != None:
            if result[1] == 'PASS':
                result = ACTION.PASS
    ...
    def run():
        result = ACTION.FAIL
        result = devInterface.sendCommandAndGetResponse(0x01, "", BCmb.timeout)
        print(result)
        if result != None:
            if result[1] == 'PASS':
                result = ACTION.PASS
    ...
    def pause():
        result = ACTION.FAIL
        result = devInterface.sendCommandAndGetResponse(0x02, "", BCmb.timeout)
        print(result)
        if result != None:
            if result[1] == 'PASS':
                result = ACTION.PASS
    ...
    def readProgram():
        result = ACTION.FAIL
        result = devInterface.sendCommandAndGetResponse(0x52, "", BCmb.timeout)
        print(result)
        if result != None:
            if result[1] == 'PASS':
                result = ACTION.PASS
    ...
    def readVoltage():
        result = ACTION.FAIL
        result = devInterface.sendCommandAndGetResponse(0x56, "", BCmb.timeout)
        print(result)
        if result != None:
            if result[1] == 'PASS':
                result = ACTION.PASS
    ...
    def readTemperature():
        result = ACTION.FAIL
        result = devInterface.sendCommandAndGetResponse(0x54, "", BCmb.timeout)
        print(result)
        if result != None:
            if result[1] == 'PASS':
                result = ACTION.PASS
    ...
    def readCurrent():
        result = ACTION.FAIL
        result = devInterface.sendCommandAndGetResponse(0x49, "", BCmb.timeout)
        print(result)
        if result != None:
            if result[1] == 'PASS':
                result = ACTION.PASS
    ...
    def readStep():
        result = ACTION.FAIL
        result = devInterface.sendCommandAndGetResponse(0x50, "", BCmb.timeout)
        print(result)
        if result != None:
            if result[1] == 'PASS':
                result = ACTION.PASS
    ...
    def currentTime():
        result = ACTION.FAIL
        result = devInterface.sendCommandAndGetResponse(0x74, "", BCmb.timeout)
        print(result)
        if result != None:
            if result[1] == 'PASS':
                result = ACTION.PASS
