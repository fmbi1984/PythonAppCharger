...
if __name__ == "__main__":
    print("tests")
    #BCmb.readData(1)
    #BCmb.pingClient('raspberrypi.local',1)
    #BCmb.ping(2)
    ...
    '''
    BCmb.openFileClient('raspberrypi.local',1)
    sleep(0.1)

    for i in range(0,30):
        BCmb.memoryDataClient('raspberrypi.local', 1)

    
    BCmb.closeFileClient('raspberrypi.local',1)
